...
class AssistApply(unittest.TestCase):
    """申请协催接口"""
    def setParameters(self,case_name, url, method, caseId, applyRemark,code, message):
    ...
    def test_assistApply(self):
        ...
        if self.method == 'post_json':
            datas = {"caseId": self.caseId,"applyRemark":self.applyRemark}
            print('请求参数：',datas)
